...
import com.example.art_lover.service.MuseumArtworkService;
import com.example.art_lover.service.WikiDataService;
import com.example.art_lover.service.EuropeanaService;
import com.example.art_lover.service.WikimediaService;
...
public class GeminiAILImageRecognitionService {
    ...
    private final EuropeanaService europeanaService;

    public GeminiAILImageRecognitionService(Client client, MuseumArtworkService museumImageSearchService,
            WikimediaService wikimediaService, EuropeanaService europeanaService) {
        this.client = client;
