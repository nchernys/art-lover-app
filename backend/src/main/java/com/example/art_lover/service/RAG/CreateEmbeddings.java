...
// throw new RuntimeException("MONGODB_URI env variable is not set or is
// empty.");
// }
...
// collection.find(filterCriteria).limit(50).iterator()) {
...
// System.out.println("Generating embeddings for " + summaries.size() + "
// documents.");
...
// }
// System.out.println("Added embeddings successfully to " + updatedDocsCount + "
// documents.");
// }
// } catch (MongoException me) {
